export default function Slide8Revenue() {
  return (
    <div style={{ width: '100vw', height: '100vh', overflow: 'hidden', position: 'relative', backgroundColor: '#0C0F1A', fontFamily: "'Inter', sans-serif", color: '#FFFFFF' }}>
      ...
      <div style={{ position: 'relative', zIndex: 10, display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: '10vh', paddingBottom: '8vh', paddingLeft: '5vw', paddingRight: '5vw', height: '100%', boxSizing: 'border-box' }}>
        {/* Header */}
        ...
        {/* Two-column layout */}
        <div style={{ display: 'flex', gap: '2.5vw', width: '100%', flex: 1, minHeight: 0 }}>

          {/* MAIN: Venue Partnerships */}
          <div style={{ flex: 1.6, backgroundColor: '#131726', border: '1px solid rgba(79,127,255,0.32)', borderRadius: '1vw', padding: '2.5vh 2.5vw', boxShadow: '0 1.5vh 4vh rgba(79,127,255,0.1)', display: 'flex', flexDirection: 'column' }}>
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '2vh' }}>
              <div>
                <div style={{ fontSize: '0.8vw', fontWeight: 600, color: '#4F7FFF', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '0.5vh' }}>Primary Revenue · B2B</div>
                <div style={{ fontSize: '2vw', fontWeight: 700, lineHeight: 1.15 }}>Venue Partnerships</div>
              </div>
              <div style={{ padding: '0.4vh 1vw', backgroundColor: 'rgba(79,127,255,0.15)', border: '1px solid rgba(79,127,255,0.3)', borderRadius: '0.5vw', fontSize: '1vw', fontWeight: 700, color: '#4F7FFF', whiteSpace: 'nowrap' }}>Rev share + CPM</div>
            </div>

            {/* Event feed example */}
            <div style={{ backgroundColor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '0.8vw', padding: '1.5vh 1.5vw', marginBottom: '2vh' }}>
              <div style={{ fontSize: '0.75vw', fontWeight: 600, color: 'rgba(255,255,255,0.35)', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '1.2vh' }}>Home Feed — event surfaced from a saved place</div>
              <div style={{ backgroundColor: '#0C0F1A', border: '1px solid rgba(79,127,255,0.25)', borderRadius: '0.6vw', padding: '1.2vh 1.2vw', display: 'flex', gap: '1.2vw', alignItems: 'center' }}>
                <div style={{ width: '3vw', height: '3vw', backgroundColor: 'rgba(79,127,255,0.2)', borderRadius: '0.5vw', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <div style={{ width: '1.2vw', height: '1.2vw', backgroundColor: '#4F7FFF', borderRadius: '50%' }} />
                </div>
                <div style={{ flex: 1 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.8vw', marginBottom: '0.3vh' }}>
                    <span style={{ fontSize: '1.15vw', fontWeight: 700 }}>Sommelier's Table Pop-Up</span>
                    <span style={{ fontSize: '0.75vw', fontWeight: 600, padding: '0.2vh 0.6vw', backgroundColor: 'rgba(79,127,255,0.2)', border: '1px solid rgba(79,127,255,0.4)', borderRadius: '0.3vw', color: '#4F7FFF' }}>MOVES PICK</span>
                  </div>
                  <div style={{ fontSize: '1vw', color: 'rgba(255,255,255,0.5)' }}>Maison Premiere · Williamsburg · Sat 7 PM – 11 PM</div>
                  <div style={{ fontSize: '1vw', color: 'rgba(255,255,255,0.65)', marginTop: '0.3vh' }}>You saved this spot in April. They're hosting a ticketed wine dinner this weekend.</div>
                </div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: '1.2vw', flex: 1, minHeight: 0 }}>
              <div style={{ flex: 1, backgroundColor: 'rgba(79,127,255,0.07)', border: '1px solid rgba(79,127,255,0.15)', borderRadius: '0.7vw', padding: '1.5vh 1.2vw' }}>
                <div style={{ fontSize: '0.95vw', fontWeight: 700, color: '#4F7FFF', marginBottom: '0.6vh' }}>Event Promotion</div>
                <div style={{ fontSize: '1.1vw', color: 'rgba(255,255,255,0.6)', lineHeight: 1.4 }}>Venues pay to surface events to users who've already saved their spot</div>
              </div>
              <div style={{ flex: 1, backgroundColor: 'rgba(79,127,255,0.07)', border: '1px solid rgba(79,127,255,0.15)', borderRadius: '0.7vw', padding: '1.5vh 1.2vw' }}>
                <div style={{ fontSize: '0.95vw', fontWeight: 700, color: '#4F7FFF', marginBottom: '0.6vh' }}>MOVES Pick Badge</div>
                <div style={{ fontSize: '1.1vw', color: 'rgba(255,255,255,0.6)', lineHeight: 1.4 }}>Sponsored placement in AI itineraries and search results, labeled transparently</div>
              </div>
              <div style={{ flex: 1, backgroundColor: 'rgba(79,127,255,0.07)', border: '1px solid rgba(79,127,255,0.15)', borderRadius: '0.7vw', padding: '1.5vh 1.2vw' }}>
          ...
          <div style={{ flex: 0.9, backgroundColor: '#131726', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '1vw', padding: '2.5vh 2.5vw', boxShadow: '0 1.5vh 4vh rgba(0,0,0,0.35)', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ marginTop: '2vh', fontSize: '1.05vw', color: 'rgba(255,255,255,0.3)', lineHeight: 1.5 }}>
              Keeps MOVES free for most users while monetizing heavy savers.
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ position: 'absolute', bottom: '4.5vh', right: '5vw', fontSize: '0.9vw', color: 'rgba(255,255,255,0.32)' }}>08 / 11</div>
    </div>
  );
}

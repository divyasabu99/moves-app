/**
 * MOVES Investor Pitch Script
 * ----------------------------
 * Edit this file to update the teleprompter text.
 *
 * PLACEHOLDERS — fill these in before recording:
 *   [YOUR NAME]                 → your full name
 *   [YOUR BACKGROUND — city, context] → e.g. "in Boston, the son of a chef"
 *   [X years]                   → how many years you've lived in New York
 *
 * STAGE DIRECTIONS (lines starting with [PAUSE...]) are shown as
 * muted italic cues on screen — they are NOT read aloud.
 */
